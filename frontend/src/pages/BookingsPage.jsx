				...
				<article className="panel-card booking-request-card booking-section-card">
					...
					<form className="booking-request-form booking-request-form--v2" onSubmit={handleCreateBooking}>
						<label className="booking-request-field">
							...
							>
								<option value="">
									{isLoadingResources ? "Loading available resources..." : "Select active resource"}
								</option>
							...
							{selectedResource ? (
								...
								<small className="booking-help-text">Choose from active resources. ID is selected automatically.</small>
							)}
						</label>
